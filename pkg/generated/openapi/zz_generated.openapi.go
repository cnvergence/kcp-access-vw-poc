...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.AccessEndpointSlice":           schema_pkg_apis_access_v1alpha1_AccessEndpointSlice(ref),
		"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReview":       schema_pkg_apis_access_v1alpha1_SelfClusterAccessReview(ref),
		"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewList":   schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewList(ref),
		"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewStatus": schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewStatus(ref),
...
func schema_pkg_apis_access_v1alpha1_AccessEndpointSlice(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AccessEndpointSlice maps a logical cluster the caller can access to the API URL it can be reached at.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"clusterName": {
						SchemaProps: spec.SchemaProps{
							Description: "ClusterName is the logical cluster identifier (kcp's \"logicalcluster\" name).",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"endpoint": {
						SchemaProps: spec.SchemaProps{
							Description: "Endpoint is the FrontProxy URL the caller can address this cluster at.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"clusterName", "endpoint"},
			},
		},
	}
}

func schema_pkg_apis_access_v1alpha1_SelfClusterAccessReview(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SelfClusterAccessReview is the response a caller gets when asking the Access Virtual Workspace \"which workspaces can I see?\".\n\nIt is a Kubernetes-shaped self-review resource, modelled on SelfSubjectAccessReview: callers POST a request, the server fills in Status from the authenticated identity, and the populated resource comes back in the response. There is no Spec because the caller does not parameterise the question — the only input is the caller's own identity, taken from the request's auth headers.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Standard object metadata. Empty on requests; the server may populate CreationTimestamp on responses but otherwise leaves this empty for self-review resources.",
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReviewStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SelfClusterAccessReviewList is the list form of SelfClusterAccessReview. Self-review resources are normally not listed; the type exists so the resource can be registered with a scheme without special-casing.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReview"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.SelfClusterAccessReview", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_access_v1alpha1_SelfClusterAccessReviewStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SelfClusterAccessReviewStatus carries the list of clusters the authenticated subject can access.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"clusters": {
						SchemaProps: spec.SchemaProps{
							Description: "Clusters is the list of logical clusters the subject has at least 'view' access to, paired with each cluster's FrontProxy endpoint URL. Sorted by ClusterName for stable output.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.AccessEndpointSlice"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/cnvergence/kcp-access-vw/pkg/apis/access/v1alpha1.AccessEndpointSlice"},
	}
}
